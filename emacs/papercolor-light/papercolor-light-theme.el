...
(let ((base00 "#262626")
  ...
  (custom-theme-set-faces
   ...
   `(vertical-border ((t (:background ,vert-split-bg :foreground ,vert-split-fg))))
   `(border-glyph ((t (nil))))
   ...
   `(fringe ((t (:background ,fringe-bg))))
   `(gui-element ((t (:background ,base03 :foreground ,base06))))
   `(highlight ((t (:background ,cursor-line))))
   `(link ((t (:foreground ,link-fg))))
   `(link-visited ((t (:foreground ,link-visited-fg))))
   `(minibuffer-prompt ((t (:foreground ,minibuffer-prompt-fg))))
   `(mode-line ((t (:background ,mode-line-active-bg :foreground ,mode-line-active-fg :box (:line-width 1 :color "#1A2F54")))))
   `(mode-line-buffer-id ((t (:foreground ,mode-line-buffer-id-fg :background nil :weight bold))))
   `(mode-line-emphasis ((t (:foreground ,mode-line-emphasis-fg :slant italic))))
   `(mode-line-highlight ((t (:foreground ,mode-line-highlight-fg :box nil :weight bold))))
   `(mode-line-inactive ((t (:background ,mode-line-inactive-bg :foreground ,mode-line-inactive-fg :box (:line-width 1 :color "#4E4E4C")))))
   `(region ((t (:background ,visual-bg :foreground ,visual-fg))))
   ...
   `(font-lock-constant-face ((t (:foreground ,base0D))))
   ...
   `(whitespace-line ((t (:background "#ffff88" :foreground "#cc0000"))))
   ...
   `(helm-buffer-directory ((t (:foreground "#949494" :background nil :weight bold))))
   ...
   `(helm-ff-directory ((t (:foreground "#949494" :background nil :weight bold))))
   ...
   `(helm-header ((t (:foreground "#eeeeee" :background "#005f87" :underline nil))))
   `(helm-match ((t (:foreground "#4271ae"))))
   `(helm-moccur-buffer ((t (:foreground "#3e999f"))))
   `(helm-selection ((t (:foreground nil :background "#4d4d4c" :underline nil))))
   `(helm-selection-line ((t (:foreground nil :background "#4d4d4c"))))
   `(helm-separator ((t (:foreground "#4d4d4c"))))
   `(helm-source-header ((t (:foreground "#d0d0d0" :background "#262626" :weight bold))))
