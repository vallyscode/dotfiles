...
(let ((base00 "#262626")
      ...
      (status-line-active-fg "#e4e4e4")
      (status-line-active-bg "#005f87")
      (status-line-inactive-fg "#444444")
      (status-line-inactive-bg "#d0d0d0")
      (error-fg "#af0000")
      (error-bg "#ffd7ff")
      (visual-fg "#eeeeee")
      (visual-bg "#0087af"))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((t (:background ,status-line-active-bg :foreground ,status-line-active-fg :box nil))))
   ...
   `(mode-line-inactive ((t (:background ,status-line-inactive-bg :foreground ,status-line-inactive-fg :box nil))))
