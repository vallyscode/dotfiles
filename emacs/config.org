...
#+END_SRC
** default
Awesome default emacs theme.
#+BEGIN_SRC emacs-lisp
  (load-theme 'leuven t)
#+END_SRC
** solarized
Solarized light/dark theme, looks awesome.
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** doneburn (sunburn)
Good simple looking light theme.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package octopus
    :load-path "~/workspace/projects/elisp/octopus")
  (require 'octopus)
  ...
  ;;   :load-path "~/workspace/projects/elisp/lsp-mode")
  ;; (require 'lsp-mode)

  ;; (use-package dash-functional
  ;;   :ensure t)
  ;; (use-package lsp-ui
  ;;   :load-path "~/workspace/projects/elisp/lsp-ui")

  ;; (use-package lsp-java
  ;;   :load-path "~/workspace/projects/elisp/lsp-java")

  ;; (add-hook 'java-mode-hook #'lsp-java-enable)
  ;; ;; set the projects that are going to be imported into the workspace.
  ;; (setq lsp-java--workspace-folders (list "~/workspace/projects/java/sample"))
#+END_SRC
